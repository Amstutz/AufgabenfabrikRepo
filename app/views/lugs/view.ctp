...
<fieldset>
	<legend><?php __($lug['Lug']['name']); ?></legend>
	...
	<br>
	<div class="actions">
		<?php echo $this->Html->link(__('LUG bearbeiten', true), array('action' => 'edit', $lug['Lug']['id'])); ?> 
		<?php echo $this->Html->link(__('LUG Löschen', true), array('action' => 'delete', $lug['Lug']['id']), null, sprintf(__('Soll der Handlungsaspekt %s wirklich gelöscht werden?', true), $lug['Lug']['name'])); ?> 
	</div>
</fieldset>
<fieldset>
	<legend><?php __("Testaufgaben für diese LUG"); ?></legend>
	<table cellpadding="0" cellspacing="0">
	<tr>
	...
	<?php
	$i = 0;
	foreach ($lug['Exercise'] as $exercise):
		$class = null;
		$altrow = 0;
		$i++;
		if ($i % 2 == 0) {
