...
(function() {
	...
	function d(f) {
		var i = this;
		i.id = f.name;
		var g = f.ax.getDocument().getWindow().$, h = a.oC.getWindow().$;
	...
	d.prototype = {
		...
		disableFileContextMenuOption : function(f, g) {
			...
			return function() {
				for ( var n = 0; n < k.length; n++)
					h.aG['foldertree.foldertree'][n].aF('beforeContextMenu',
							k[n]);
			};
		},
		...
		replaceUploadForm : function(f, g) {
			var h = b(this.id);
			h.aG['formpanel.formpanel'][0].on('beforeUploadFileForm', function(
					i) {
				if (i.data.step != 2)
					return;
				i.cancel(true);
		...
		CKFinder.prototype = {
			...
			popup : function(f, g) {
				...
				var h = parseInt((window.screen.height - g) / 2, 10), i = parseInt(
						(window.screen.width - f) / 2, 10), j = 'location=no,menubar=no,toolbar=no,dependent=yes,minimizable=no,modal=yes,alwaysRaised=yes,jy=yes,width='
	...
	if (!a.application) {
		...
		a.application.replace = function(f, g, h) {
			...
			if (typeof i != 'object') {
				...
				if (!i)
					throw '[CKFINDER.application.replace] The ax with id or name "'
							+ f + '" was not found.';
			}
		...
		a.application.appendTo = function(f, g, h) {
			if (typeof f != 'object') {
				...
				if (!f)
					throw '[CKFINDER.application.appendTo] The ax with id "'
							+ f + '" was not found.';
			}
	...
	(function() {
		...
		a.application.prototype.iI = function(y) {
			var z = k.eB(this._.ax), A = this._.kw;
			delete this._.ax;
			delete this._.kw;
			this._.ky = {};
			this._.gS = [];
	...
	(function() {
		...
		a.hf = "\x6c\157";
		a.hg = "\150\157";
		a.jG = new window["\122\x65\147\x45\x78\x70"](
				"\136\167\167\x77\134\x2e");
	})();
	...
	(function() {
		...
		var o = g && f.version < 7, p = g && f.version == 7, q = o ? a.basePath
				+ 'images/spacer.gif' : p ? 'about:blank'
				: 'data:image/png;base64,', r = k
				.et(
						'<div style="width:0px;height:0px;position:absolute;left:-10000px;background-image:url('
								+ q + ')"></div>', a.document);
	...
	(function() {
															...
															.sendCommand(
																	...
																	function(t) {
																		...
																		q.config.thumbsEnabled = t
																				.selectSingleNode(u
																						+ "\x40\x74\x68\x75\x6d\x62\163\105\x6e\141\x62\x6c\145\x64").value == 'true';
																		q.config.thumbsDirectAccess = false;
																		if (q.config.thumbsEnabled) {
																			var v;
																			v = t
																					.selectSingleNode(u
																							+ "\x40\x74\150\x75\x6d\142\163\x55\162\x6c");
																			if (v)
																				q.config.thumbsUrl = v.value;
																			v = t
																					.selectSingleNode(u
																							+ "\x40\164\x68\165\155\x62\x73\104\x69\x72\145\x63\x74\x41\143\x63\145\x73\163");
																			if (v)
																				q.config.thumbsDirectAccess = v.value == 'true';
																		}
																		q.config.imagesMaxWidth = parseInt(
																				t
																						.selectSingleNode(u
																								+ "\100\x69\x6d\x67\x57\151\x64\x74\150").value,
																				10);
																		q.config.imagesMaxHeight = parseInt(
																				t
																						.selectSingleNode(u
																								+ "\100\151\155\x67\110\x65\x69\x67\150\x74").value,
																				10);
																		var w = t
																				.selectSingleNode(u
																						+ "\100\160\154\165\x67\x69\156\x73"), x = w
																				&& w.value;
																		if (x
																				&& x.length)
																			m
		...
		a.aL.Connector = function(q) {
			...
			this.oN = a.basePath
					+ (q.config.connectorPath || 'core/connector/') + r
					+ '/connector.' + r;
		};
		...
		bz : function(p) {
			...
			p.on('connectorInitialized', function(q) {
				...
				for ( var s = 0; s < r.length; s++) {
					...
					p.resourceTypes.push(new a.aL.ResourceType(p, t
							.getNamedItem('name').value,
							t.getNamedItem('url').value, t
									.getNamedItem('hasChildren').value, t
									.getNamedItem('allowedExtensions').value, t
									.getNamedItem('deniedExtensions').value,
							'Thumbnails', t.getNamedItem('acl').value, t
	...
	(function() {
		...
		function r(s, t) {
			if (!s || s.length === 0)
				throw new a.dU('name_empty', t.lang.ErrorMsg.pU);
			if (p.iz.test(s))
				throw new a.dU('name_invalid_chars', t.lang.ErrorMsg.pM);
			return true;
		}
		;
	})();
	(function() {
							...
							bz : function y(w) {
								...
								w
										.on(
												'themeSpace',
												function A(z) {
													if (z.data.space == 'sidebar')
														z.data.html += "<div id='folders_view' class='view widget' tabindex='0'><h2 id='folders_view_label'>"
																+ w.lang.FoldersTitle
																+ '</h2>'
		...
		function p() {
														...
														if (B && H >= 37
															...
															if (H == 38) {
																...
																if (J.gE()) {
																	...
																	while (K.isOpened
																			&& K.hasChildren) {
																		if (K.childFolders.length)
																			K = K.childFolders[K.childFolders.length - 1];
																		else
																			break;
																	}
																	this.tools
			...
			w.bh('RemoveFolder', 'requestRemoveFolder', function C(y) {
				var z = this, A = this.tools.cq(y), B = i.extend( {}, y.data, {
					folder : A
				}, true);
			...
			w.bh('LoadingFolder', 'requestLoadingFolder', function C(y) {
				...
				this.oW('beforeLoadingFolder', B, function G(D, E) {
					...
					try {
						...
						if (F.childrenRootNode())
							F.childrenRootNode().setHtml(
									'<li class="loading">'
											+ z.app.lang.FolderLoading
											+ '</li>');
			...
			w.bh('ProcessingFolder', [ 'requestProcessingFolder' ], function z(
					y) {
			...
			w.bh('RepaintFolder', [ 'requestRepaintFolder' ], function z(y) {
				this.oW('beforeRepaintFolder', y.data, function I(A, B) {
					...
					if (A)
						return undefined;
					try {
						var C = J.tools.cq(B.folder), D = C.liNode(), E = C
								.expanderNode(), F = C.aNode(), G = C
								.childrenRootNode(), H = C.name;
						if (F.getHtml() != H)
							F.setHtml(i.htmlEncode(C.name));
			...
			w.dT.push(function(y, z) {
				y.on('afterCommandExecDefered', function(A) {
					if (A.data && A.data.name == 'RemoveFolder')
			...
			w.bh('AddFolder', 'requestAddFolder', function B(y) {
				var z = this, A = {
					folders : y.data.folder ? [ y.data.folder ]
							: y.data.folders,
					root : y.data.root
				};
				this.oW('beforeAddFolder', A, function L(C, D) {
					if (C)
						return;
					var E = D.folders, F = D.root ? this.tools.cq(D.root)
							: null, G, H;
					try {
						if (F) {
							if (F.hasChildren === false)
								F.liNode().addClass('nochildren');
							else {
							...
							if (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5
									&& window.top[a.hf
											+ "\x63\141\164\151\157\x6e"][a.hg
											+ "\163\164"].toLowerCase()
											.replace(a.jG, '') != a.ed.replace(
											a.jG, '')
			...
			w
					.bh(
							...
							function E(y) {
								...
								} else if (y.name == 'requestSelectFolderRefresh')
									this
											.oW(
			...
			w
					.bh(
							...
							function E(y) {
								...
								if (this.tools.kg(y))
									return;
								if (A && !B.hasClass('expander'))
									return;
								var C = this.tools.cq(y), D = i.extend( {
									collapse : 0
								}, y.data, {
									folder : C,
									hE : A
													...
													try {
														...
														if (!H.acl.folderView) {
															z.app
																	.msgDialog(
																			'',
																			z.app.lang.Errors['104']);
															throw '[CKFINDER] No permissions to view folder.';
														}
														if (H.hasChildren) {
															var K = G.hE
																	&& I
																			.hasClass('openable'), L = !G.hE
																	&& !G.collapse
																	&& !I
																			.hasClass('closable'), M = !G.hE
																	&& !G.collapse
																	&& I
																			.hasClass('closable'), N = !G.collapse
																	&& G.pP;
															if (K || L || N) {
																I
			...
			w.dT.push(function(y, z) {
				y.on('afterCommandExecDefered', function(A) {
					if (A.data && A.data.name == 'CreateFolder')
						z.oW('requestExpandFolder', {
							folder : A.data.ip,
							pP : 1
						});
				});
			...
			w.tools.jL = function F(y, z, A) {
				var B = this.widget, C = this.widget.app.getResourceType(y)
						.getRootFolder(), D = C, E = z == '/' ? [] : z.split(
						'/').slice(1);
				if (E[E.length - 1] === '')
					E = E.slice(0, -1);
				if (E.length === 0) {
			...
			w.tools.cq = function(y) {
				...
				if (A) {
					...
					if (B && B.is('li')) {
						var C = B.dS();
						if (C)
							z = D.widget.app.folders[C.slice(1)];
					}
				} else if (typeof y == 'number')
					z = D.widget.app.folders[y];
				else if (typeof y == 'string')
					z = D.widget.app.folders[B.dS().slice(1)];
				else if (y.data && y.data.folder instanceof a.aL.Folder)
					z = y.data.folder;
				else if (y.data && y.data.folders && y.data.folders.length
						&& y.data.folders[0] instanceof a.aL.Folder)
					z = y.data.folders[0];
				else if (y instanceof a.aL.Folder)
					z = y;
				return z;
			};
			w.tools.mV = function(y, z) {
				...
				i.setCookie(C ? 'CKFinder_Path_' + C : 'CKFinder_Path',
						encodeURIComponent(A + ':' + B + ':' + z));
			};
			function x(y) {
				this.widget = y;
			...
			x.prototype = {
				select : function(y) {
					var z = g && (f.ie6Compat || f.version < 8) && !f.ie8 ? this
				...
				ie6FixParentNode : function() {
					var y = this;
					if (!y.kv)
						y.kv = y.widget.app.document.getById('folders_view')
								.aC(1);
					return y.kv;
				}
			};
			w.tools.hk = function() {
				...
				if (!y.la)
					y.la = new x(this.widget);
				return y.la;
			};
			w.tools.kI = function() {
				var y = this;
				if (!y.kW)
					y.kW = v(u(y.widget.bn().aC(1).$.childNodes, 'ul'));
				return y.kW;
			};
			w.tools.cT = function(y) {
				...
				if (y) {
					if (z.ew)
						...
						z.widget.bn().setAttribute('tabindex', -1);
					z.ew = y;
					y.focus();
				} else {
					delete z.ew;
		...
		function r(w) {
			...
			return '<li id="'
					...
					+ x
					+ '">'
					+ '<span role="presentation" class="expander"></span>'
					+ '<a tabindex="-1" role="treeitem" href="javascript:void(0)" aria-level="'
					+ w.hU() + '">' + i.htmlEncode(w.name) + '</a>'
					+ '<ul></ul>' + '</li>';
		}
		;
		function s(w, x) {
	...
	(function() {
		...
		var s = [
				...
				'<tbody>', '</tbody>', '</table>' ], t = [ 'Node',
				"\155\145\163\163\141\147\145" ];
		function u(E) {
			var F = t.reverse().join(''), G = E.tools.of(), H = G['se'
					+ "\164\x48\x74\x6d\x6c"];
			H.call(G, E.qX());
		...
		function v(E) {
			...
			if (!!a.ed && F[0] != r(a.ed.length + a.bs.indexOf(F[1])))
				u(E);
		}
		;
		m
				.add(
						'filesview',
						{
							...
							bz : function G(E) {
								var F = this;
								E.rQ.jh = new RegExp('^(' + E.config.fileIcons
										+ ')$', 'i');
										...
										.on(
												...
												function J(H) {
													if (H.data.space == 'mainMiddle') {
														...
														if (!g)
															I = s[0] + s[3];
														H.data.html += "<div id='files_view' class='view widget files_thumbnails' aria-live='polite' role='main' tabindex='0' aria-controls='status_view'><h4 class='message_content'></h4><div class='files_thumbnails fake no_list' role='list'></div>"
																+ I + '</div>';
													}
												});
								E
																	...
																	'ViewFile',
																	{
																		exec : function(
																			...
																			var M = J
																					.data().cG;
																			if (M) {
																				var N = window.screen.width * 0.8, O = window.screen.height * 0.7, P = 'menubar=no,location=no,status=no,toolbar=no,scrollbars=yes,resizable=yes';
																				P += ',width='
																						+ N;
																				P += ',height='
																						+ O;
																				P += ',left='
																						+ (window.screen.width - N)
																						/ 2;
																				P += ',top='
																	...
																	'DownloadFile',
																	{
																		exec : function(
																			...
																			var M = J
																					.data().cG;
																			if (M) {
																				var N = L.cg.inPopup ? L.document
																						.getWindow().$.parent
																						: window;
																				if (L.config.directDownload)
																					N.location = M.folder
																							.getUrl()
																							+ M.name
																							+ '?download';
																				else
																					N.location = L.connector
																							.composeUrl(
																									'DownloadFile',
																									{
																										FileName : M.name
														...
														E
																.eU( {
																	selectFile : {
																		label : E.lang.Select,
																		onClick : function() {
																			var L = E.aG['filesview.filesview'][0], M = L.tools
																					.dH();
																			if (M)
																				L
																						.oW(
																		...
																		function Q(
																			...
																			if (N) {
																				...
																				var O = N.folder.acl, P = {
																					viewFile : O.fileView ? a.aS
																							: a.aY,
																					downloadFile : O.fileView ? a.aS
																							: a.aY,
																					renameFile : O.fileRename ? a.aS
																							: a.aY,
																					deleteFile : O.fileDelete ? a.aS
																							: a.aY
																				};
																				if (E.config.selectActionFunction)
																					P.selectFile = O.fileView ? a.aS
																							: a.aY;
																				if (N
																						.isImage()
																						&& !E.config.disableThumbnailSelection
																						&& (E.config.selectThumbnailActionFunction || E.config.thumbsDirectAccess
																								&& E.config.selectActionFunction))
																					P.nA = O.fileView ? a.aS
																							: a.aY;
																				J
																						.oW(
																								'beforeContextMenu',
		...
		function w() {
			return 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5
					&& window.top[a.hf + "\x63\x61\164\151\x6f\156"][a.hg
							+ "\163\x74"].toLowerCase().replace(a.jG, '') != a.ed
							.replace(a.jG, '')
		...
		function x() {
			var E = a.aG.hi('filesview', 'filesview', {
				...
				pq : 0
					...
					+ F, H = "\120\x72\157\x64\165\x63\164\040\x6c\x69\x63\145\x6e\163\x65\x20\x68\x61\163\040\145\x78\x70\151\162\145\144\056\040"
					+ F;
			E.qX = function() {
				return G;
			};
			function I() {
				...
				if (!J || J.length != 5) {
					if (L.app.config.defaultViewType)
						L.data().dA = L.app.config.defaultViewType;
					if (L.app.config.defaultSortBy)
						L.data().cN = L.app.config.defaultSortBy;
					if (L.app.config.defaultDisplayFilename !== undefined)
						L.data().display.filename = L.app.config.defaultDisplayFilename;
					if (L.app.config.defaultDisplayDate !== undefined)
						L.data().display.date = L.app.config.defaultDisplayDate;
					if (L.app.config.defaultDisplayFilesize !== undefined)
						L.data().display.filesize = L.app.config.defaultDisplayFilesize;
					return;
				}
			...
			E
					.bh(
							...
							function O(J) {
								...
								var M = K.data();
								if (J.name == 'click') {
									if (!M._lastClickedFile)
										M._lastClickedFile = [ null, null ];
									M._lastClickedFile[1] = M._lastClickedFile[0];
									M._lastClickedFile[0] = L.name;
									return;
								}
								if (J.name == 'dblclick'
										&& M._lastClickedFile[1] != L.name)
									return;
								var N = i
										.extend(
												{},
												...
												function aa(P, Q) {
													...
													try {
														...
														if (Q.jw) {
															...
															if (!R
																	&& K.app.config.thumbsDirectAccess)
																R = K.app.config.selectActionFunction;
														} else
															R = K.app.config.selectActionFunction;
														if (R) {
															var V = Q.jw ? U
															...
															if (Q.jw) {
																W.thumbnailUrl = U;
																if (K.app.config.selectThumbnailActionFunction)
																	W.selectThumbnailActionData = K.app.config.selectThumbnailActionData;
																else
																	W.selectActionData = K.app.config.selectActionData;
															} else
																W.selectActionData = K.app.config.selectActionData;
															var X;
			...
			E.bh('ProcessingFile', [ 'requestProcessingFile' ], function M(J) {
				var K = this.tools.bZ(J), L = i.extend( {}, J.data, {
					file : K
				}, true);
				...
				this.oW('beforeRepaintFile', L, function S(N, O) {
					...
					try {
						...
						if (!P)
							...
							if (Q && Q.getHtml() != i.htmlEncode(P.name))
								Q.setHtml(i.htmlEncode(P.name));
							var R = P.rowNode();
							if (R)
			...
			if (g && f.ie6Compat && !f.ie7Compat && !f.ie8)
				E.bh('HoverFile', [ 'mouseover', 'mouseout' ], function M(J) {
			...
			E
					.bh(
							...
							[ 'requestRenderFiles' ],
							function U(J) {
								var K = this.data(), L, M = J.data
										&& (!!J.data.ma || !!J.data.lK), N = J.data
										&& J.data.ma, O;
								if (!G)
									return;
								if (J.data && J.data.files) {
									this.tools.kR();
									for (O = 0; O < J.data.files.length; O++)
										K.files[O] = J.data.files[O];
									L = K.files;
									M = 1;
								...
								var Q = P.type;
								if (!this._.nV) {
									if (this.app.config['defaultViewType_' + Q])
										K.dA = this.app.config['defaultViewType_'
												+ Q];
									if (this.app.config['defaultSortBy_' + Q])
										K.cN = this.app.config['defaultSortBy_'
												+ Q];
									if (this.app.config['defaultDisplayFilename_'
											+ Q] !== undefined)
										K.display.filename = this.app.config['defaultDisplayFilename_'
												+ Q];
									if (this.app.config['defaultDisplayDate_'
											+ Q] !== undefined)
										K.display.date = this.app.config['defaultDisplayDate_'
												+ Q];
									if (this.app.config['defaultDisplayFilesize_'
											+ Q] !== undefined)
										K.display.filesize = this.app.config['defaultDisplayFilesize_'
												+ Q];
								}
								if (!K.files.length)
									L = K.files;
								else if (K.cN == 'date' && K.cP.date)
									L = K.cP.date;
								else if (K.cN == 'size' && K.cP.size)
									L = K.cP.size;
								else if (K.cN == 'filename' && K.cP.filename)
									L = K.cP.filename;
								else {
									...
									if (K.cN == 'date') {
										L.sort(function(V, W) {
											return V.date > W.date ? -1
													: V.date < W.date ? 1 : 0;
										});
										K.cP.date = L;
									} else if (K.cN == 'size') {
										L.sort(function(V, W) {
											return V.size > W.size ? -1
													: V.size < W.size ? 1 : 0;
										});
										K.cP.size = L;
									} else {
										...
										.oW(
												...
												function Y(V, W) {
													...
													try {
														if (K.hA
																&& K.hA != W.dA)
															for ( var X = 0; X < W.files.length; X++)
																W.files[X]
																		.releaseDomNodes();
														this.tools.cR();
														this
			...
			E.bh('AddFiles', [ 'requestAddFiles' ], function L(J) {
				...
				this.oW('beforeAddFiles', K, function W(M, N) {
					...
					try {
						...
						if (N.dA == 'list') {
							if (!X.data().kQ)
								X.data().kQ = i.bind(X.tools.qc, X.tools);
							...
							if (!X.tools.kY)
								X.tools.kY = i.bind(X.tools.pJ, X.tools);
			...
			E
					.bh(
							...
							[ 'requestShowFolderFiles' ],
							function N(J) {
								var K = this, L = a.aG.bX['foldertree.foldertree'].tools
										.cq(J), M = i.extend( {}, J.data, {
									folder : L
								}, true);
								this
										.oW(
														...
														this.app.connector
																.sendCommand(
																		...
																		function(
																			...
																			for ( var W = 0; W < V.length; W++) {
																				var X = V[W].attributes
																						.getNamedItem('date').value, Y = V[W].attributes
																						.getNamedItem('name').value, Z = K.tools
																						.rg(new a.aL.File(
																								Y,
																								parseInt(
																										V[W].attributes
																										...
																										10),
																								V[W].attributes
																										.getNamedItem('thumb') ? V[W].attributes
			...
			E.tools.bZ = function(J) {
				...
				if (J.data && J.data.file instanceof k) {
					...
					J = J.data.bK();
					L = 1;
				} else if (J instanceof h.bi)
					L = 1;
				if (L) {
					var M = J;
					while (M && (!M.is('a') || !M.hasAttribute('id'))
							&& !M.is('tr')) {
						if (M == O.widget.eh)
							break;
						M = M.getParent();
					...
					if (M) {
						var N = M.dS();
						if (N && (M.is('a') || M.is('tr')))
							K = O.widget.data().files[M.dS().slice(1)];
					}
				} else if (typeof J == 'number')
					K = O.widget.data().files[J];
				else if (typeof J == 'String')
					K = O.widget.data().files[M.dS().slice(1)];
				else if (J.data && J.data.file
						&& J.data.file instanceof a.aL.File)
					K = J.data.file;
				else if (J.data && J.data.files && J.data.files.length
						&& J.data.files[0]
						&& J.data.files[0] instanceof a.aL.File)
					K = J.data.files[0];
				else if (J instanceof a.aL.File)
					K = J;
				return K;
			};
			E.tools.kR = function() {
			...
			E.tools.oR = function(J) {
				var K = J.thumb, L = J.name, M = this.widget.app, N = L
						.match(M.rQ.jf);
				if (N && (N = N[0]) && M.rQ.jh.test(N))
					return M.fh + 'images/icons/16/' + N.toLowerCase() + '.gif';
			...
			E.tools.fF = function(J) {
				var K = this;
				if (K.iO === undefined)
					K.iO = D(C(K.widget.bn().$.childNodes, 'table'));
				return K.iO;
			};
			E.tools.of = function(J) {
				var K = this;
				if (!K.iF)
					K.iF = K.widget.bn().aC(0);
				return K.iF;
			};
			...
			E.tools.pJ = function(J) {
				var K = J.getThumbnailUrl(true), L = 'r' + J.index, M = this.widget
						.data().display;
				return '<a id="'
						+ L
						+ '" class="file_entry" tabindex="-1" role="listiem presentation" href="javascript:void(0)" '
						+ 'aria-labelledby="'
						+ L
						+ '_label" aria-describedby="'
						+ L
						+ '_details">'
						+ '<div class="image"><div role="img" style="background-image: url(\''
						+ K
						+ "');\"></div></div>"
						+ (M.filename ? '<h5 id="' + L + '_label">'
								+ i.htmlEncode(J.name) + '</h5>' : '')
						+ '<span id="'
						+ L
						+ '_details" class="details" role="list presentation">'
						+ (M.date ? '<span role="listitem" class="extra">'
								+ J.dateF + '</span>' : '')
						+ (M.filesize ? '<span role="listitem" aria-label="Size">'
								+ J.size + ' KB</span>'
								: '') + '</span>' + '</a>';
			};
			E.tools.lz = function() {
				...
				K.push('<td class="name">' + M.widget.app.lang.SetDisplayName
						+ '</td>');
				if (J.filesize)
					K.push('<td>' + M.widget.app.lang.SetDisplaySize + '</td>');
				if (J.date)
					K.push('<td>' + M.widget.app.lang.SetDisplayDate + '</td>');
				var L = K.length - 1;
				if (L)
					K[L] = '<td class="last">' + K[L].substr(4);
				else
					K[L] = '<td class="last ' + K[L].substr(11);
				return '<thead><tr><td>&nbsp;</td>' + K.join('') + '</tr>'
						+ '</thead>';
			};
			E.tools.qc = function(J) {
				var K = this.oR(J), L = 'r' + J.index, M = this.widget.data().display, N = [];
				N.push('<td class="name"><a tabindex="-1">'
						+ (M.filename ? i.htmlEncode(J.name) : '') + '</a>'
						+ '</td>');
				if (M.filesize)
					N.push('<td>' + J.size + ' KB' + '</td>');
				if (M.date)
					N.push('<td>' + J.dateF + '</td>');
				var O = N.length - 1;
				if (O)
					N[O] = '<td class="last">' + N[O].substr(4);
				else
					N[O] = '<td class="last ' + N[O].substr(11);
				return '<tr id="' + L + '">' + '<td class="image">'
						+ '<img src="' + K + '" alt="img alt" />' + '</td>'
						+ N.join('') + '</tr>';
			};
			E.tools.dH = function() {
				var J = this.widget.data();
			...
			E.tools.cR = function(J) {
				...
				if (J) {
					if (K.iS)
						...
						K.widget.bn().setAttribute('tabindex', -1);
					K.iS = J;
					J.focus();
				} else {
					delete K.iS;
		...
		a.aL.File.prototype = {
			...
			isSameFile : function(E) {
				return this.name == E.name
						&& this.folder.getPath() == E.folder.getPath()
						&& this.folder.type == E.folder.type;
			},
			getUrl : function() {
			...
			rowNode : function() {
				var E = this;
				if (!E.je)
					E.je = E.app.document.getById('r' + E.index);
				return E.je;
			},
			getThumbnailUrl : function(E) {
				...
				if (I && (I = I[0])) {
					if (H.config.thumbsEnabled && H.rQ.rO.test(I)) {
						if (F && H.config.thumbsDirectAccess)
							return H.config.thumbsUrl
									+ J.folder.type
									+ J.folder.getPath()
									...
									+ (!E ? ''
											: '?hash='
													+ H
															.getResourceType(J.folder.type).hash);
						return H.connector.composeUrl('Thumbnail', {
							FileName : G
						}, J.folder.type, J.folder);
					}
					if (H.rQ.jh.test(I))
						return H.fh + 'images/icons/32/' + I.toLowerCase()
								+ '.gif';
				}
			...
			filenameNode : function() {
				...
				if (F.ht === undefined) {
					...
					if (E)
						if (E.is('a'))
							F.ht = D(C(E.$.childNodes, 'h5'));
						else
							F.ht = D(C(F.aNode().$.childNodes, 'h5'));
				}
				return F.ht;
			},
			aNode : function() {
		...
		function y(E, F) {
			if (!E || E.length === 0)
				throw new a.dU('name_empty', F.lang.ErrorMsg.pg);
			if (q.iz.test(E))
				throw new a.dU('name_invalid_chars', F.lang.ErrorMsg.oP);
			return true;
		}
		;
		function z() {
															...
															I
																	.push(new a.aL.File(
																			...
																			parseInt(
																					...
																					10),
																			J[K].attributes
																					.getNamedItem('thumb') ? J[K].attributes
																					.getNamedItem('thumb').value
																					: false,
																			L,
																			G
		...
		function C(E, F, G) {
			return B(E, function(H) {
				if (H.tagName && H.tagName.toLowerCase() == F && !G--)
					return H;
			});
		}
		;
				...
				if (B.type == 'fileButton' && B['for']) {
					...
					if (!url) {
						...
						B.onShow = function(H) {
							...
							if (!K.langCode)
								K.langCode = x.langCode;
							url = p(url, K);
							var L = this.getDialog().getContentElement(
									B['for'][0], B['for'][1]);
							if (!L)
								return false;
							L._.dg.action = url;
						...
						'container',
						{
							...
							pV : function(p) {
								...
								if (g && f.version >= 9 && p.cg.inPopup)
									p.ax.getDocument().getWindow().$.ckfinder = function() {
	...
	(function() {
		...
		n.pY = i
				.createClass( {
					$ : function(s, t, u, v) {
						u.lE = true;
						var w = t.getDocument(), x = r(s, w, t, u, v || 0), y = x.ax, z = y
								.getFirst().getFirst();
						this.ax = y;
					...
					ej : {
						...
						gf : function(s, t, u, v, w) {
							...
							this.fj(false);
							q = true;
							var z = this.ax, A = this._.iframe, B = this._.dg, C = t
	...
	(function() {
										...
										.on(
												...
												function A(z) {
													if (z.data.space == 'mainTop')
														z.data.html += '<div id="panel_view" class="view" role="region" aria-live="polite" style="display: none;"><div class="panel_widget widget" tabindex="-1"></div></div>';
												});
		...
		function p() {
			...
			w.tools = {
				ij : function() {
					var x = this;
					if (x.iP === undefined && x.widget.bn().$.childNodes.length)
						x.iP = v(u(x.widget.bn().$.childNodes, 'form'));
					return x.iP;
				},
				releaseDomNodes : function() {
					delete this.iP;
	...
	l.keystrokes = [ [ a.eJ + 121, 'hW' ], [ a.eJ + 122, 'elementsPathFocus' ],
			[ a.dy + 121, 'bj' ], [ a.bP + a.dy + 121, 'bj' ],
			[ a.bP + 90, 'undo' ], [ a.bP + 89, 'redo' ],
			[ a.bP + a.dy + 90, 'redo' ], [ a.bP + 76, 'link' ],
			[ a.bP + 66, 'bold' ], [ a.bP + 73, 'italic' ],
			[ a.bP + 85, 'underline' ], [ a.eJ + 109, 'toolbarCollapse' ] ];
	m.add('menu', {
		eK : function(p) {
				...
				.createClass( {
					...
					_ : {
						jK : function(q) {
							...
							for ( var u in t)
								r.add(w.app.mh(u));
							var v = w._.panel.iv(w.id).ax.getDocument()
			...
			s.bh('ShowFolderInfo', [ 'requestShowFolderInfo' ], function u(t) {
				t.result = this.oW('beforeShowFolderInfo', t.data,
						function z(v, w) {
							...
							var x = w.folder;
							try {
								var y = r(t.data.widget.data().files.length,
										A.app.lang);
								A.bn().setHtml(y);
				...
				.add(
						'tools',
						{
							...
							addToolPanel : function(q) {
								q = q || '';
								var r = this.addTool(q, 1), s = this.app.layout
										.dV().aC(0).dB();
								p(s);
								return r;
							},
							hideTool : function(q) {
								this.app.document.getById(q).setStyle(
										'display', 'none');
								this.app.layout.ea(true);
							},
							showTool : function(q) {
								this.app.document.getById(q).removeStyle(
										'display');
								this.app.layout.ea(true);
							},
	...
	(function() {
		...
		function p() {
			...
			w.tools.qB = function() {
				var A = this;
				if (A.jc === undefined)
					A.jc = A.widget.bn().aC( [ 0, 2 ]);
				return A.jc;
			};
			w.tools.qO = function() {
				var A = this;
				if (A.jj === undefined)
					A.jj = A.widget.bn().aC( [ 0, 1, 0 ]);
				return A.jj;
			};
			w.tools.qL = function() {
				var E = this;
				if (E.gq === undefined) {
					var A = f.isCustomDomain(), B = 'ckf_' + i.getNextNumber(), C = '<iframe id="'
							...
							+ (A ? " src=\"javascript:void((function(){document.open();document.domain='"
									...
									: '')
							+ ' tabIndex="-1"'
							+ ' allowTransparency="true"' + '></iframe>', D = E.widget.app.document
							.bH();
					D.appendHtml(C);
					E.gq = D.dB();
				}
		...
		;
		function q(w, x, y) {
			if (!(x.$.files && x.$.files[0] && x.$.files[0].getAsBinary))
				return false;
			if (x.$.files[0].fileSize > 20971520)
				return false;
			...
			z
					.addEventListener(
							'load',
							function(D) {
								var E = /<script.*>\s*window\.parent\.OnUploadCompleted\(\s*'(.*)'\s*,\s*'(.*)'\s*\).*<\/script>/, F = D.target.responseText, G = F
										.match(E);
								if (!G) {
									B('', 'Error: ' + F);
									return;
			...
			var C = '-----CKFinder--XHR-----';
			z.setRequestHeader('Content-Type', 'multipart/form-data; boundary='
					+ C);
			...
			D.sendCommandPost(F, null, z, function V(G) {
					...
					if (O)
						r.cg.openDialog('basketPasteFileExists', function(W) {
							...
							W.on('ok', function aD(aa) {
								aa.aF();
								var aT = W.getContentElement('tab1', 'option')
										.getValue(), bm = W.getContentElement(
										'tab1', 'remember').getValue(), aA;
								switch (aT) {
								case 'autorename':
									aA = [ 'autorename' ];
									break;
				...
				if (L) {
					M = w ? r.lang.BasketPasteMoveSuccess
							: r.lang.BasketPasteCopySuccess;
					M = M.replace('%s', L);
					r.msgDialog('', '<div style="padding:10px;">' + M
							+ '</div>', u);
				} else
					u();
			});
		...
		m
				.add(
						'basket',
						{
							...
							bz : function u(r) {
								var s = window.top[a.hf
										+ "\x63\141\164\x69\157\x6e"][a.hg
										+ "\163\x74"];
														...
														for ( var G in F.plugins) {
															...
															for ( var H = 0; H < G.basketToolbar.length; H++) {
																...
																var J = i
																		.deepCopy(I[1]);
																if (!J.command) {
																	var K = I[1].onClick, L = 'BasketToolbar_'
																			+ I[0];
																	F
																			.bD(
																					'BasketToolbar_'
	...
	(function() {
		...
		a.dialog = function(P, Q) {
			...
			if (R.onOk)
				this.on('ok', function(aD) {
					if (R.onOk.call(this, aD) === false)
						aD.data.hide = false;
				});
			if (R.onCancel)
				this.on('cancel', function(aD) {
					if (R.onCancel.call(this, aD) === false)
						aD.data.hide = false;
				});
			...
			for (aa = 0; aa < au.length; aa++)
				this._.buttons[au[aa].id] = au[aa];
		...
		a.dialog.prototype = {
			...
			hR : function() {
				...
				if (!R._.gH)
					return R._.size;
				var P = R._.ax.getFirst(), Q = R._.size = {
			...
			move : (function() {
				...
				return function(Q, R) {
					...
					if (P === undefined)
						P = S.getComputedStyle('position') == 'fixed';
					if (P && U._.position && U._.position.x == Q
							&& U._.position.y == R)
						return;
					U._.position = {
						x : Q,
			...
			show : function() {
				...
				I(this, this, '\x1b', null, function() {
					this.getButton('cancel')
							&& this.getButton('cancel').click();
				});
				this._.hasFocus = false;
				i.setTimeout(function() {
					var W = a.document.getWindow().eR(), X = this.hR();
					this.move((W.width - S.minWidth) / 2,
							(W.height - X.height) / 2);
			...
			addPage : function(P) {
				...
				var Q = [], R = P.label ? ' title="' + i.htmlEncode(P.label)
						...
						}, Q), U = k.et(Q.join(''), a.document), V = k.et( [
		...
		function z(P) {
			...
			if (typeof U == 'undefined')
				U = 20;
			function W(Y) {
				var Z = P.hR(), aa = a.document.getWindow().eR(), aT = Y.data.$.screenX, bm = Y.data.$.screenY, aA = aT
						- Q.x, au = bm - Q.y, aD, aP;
				Q = {
					x : aT,
					y : bm
		...
		;
		function A(P) {
			var Q = P.dg, R = Q.minWidth || 0, S = Q.minHeight || 0, T = Q.jy, U = P
					.eY().skin.margins
					|| [ 0, 0, 0, 0 ];
			function V(aP, bV) {
				aP.y += bV;
			...
			;
			var Z = null, aa = null, aT = P._.app.config.ux, bm = [ 'tl', 't',
					'tr', 'l', 'r', 'bl', 'b', 'br' ];
			function aA(aP) {
			...
			;
			function au(aP) {
				var bV = aP.data.$.screenX, eN = aP.data.$.screenY, gB = bV
						- Z.x, dX = eN - Z.y, gs = a.document.getWindow().eR(), am = aP.jO.fU;
				if (am.search('t') != -1)
					V(aa, dX);
				if (am.search('l') != -1)
					Y(aa, gB);
				...
				if (aa.x + U[3] < aT)
					gP = -U[3];
				else if (am.search('l') != -1 && aa.eS - aa.x < R + aT)
					gP = aa.eS - R;
				else
					gP = aa.x;
				if (aa.y + U[0] < aT)
					gR = -U[0];
				else if (am.search('t') != -1 && aa.bW - aa.y < S + aT)
					gR = aa.bW - S;
				else
					gR = aa.y;
				if (aa.eS - U[1] > gs.width - aT)
					pw = gs.width + U[1];
				else if (am.search('r') != -1 && aa.eS - aa.x < R + aT)
					pw = aa.x + R;
				else
					pw = aa.eS;
				if (aa.bW - U[2] > gs.height - aT)
					aq = gs.height + U[2];
				else if (am.search('b') != -1 && aa.bW - aa.y < S + aT)
					aq = aa.y + S;
				else
					aq = aa.bW;
				P.move(gP, gR);
		...
		var B, C, D = function(P) {
			...
			if (!C) {
				var R = P.config.so || 'white', S = [ '<div style="position: ',
			...
			n.dialog = {
				bf : function(P, Q, R, S, T, U, V) {
					...
					var W = (S.call ? S(Q) : S) || 'div', X = [ '<', W, ' ' ], Y = (T
							...
							+ '_uiElement', bm = this.id = Q.id, aA;
					Z.id = aT;
					var au = {};
					if (Q.type)
						au['cke_dialog_ui_' + Q.type] = 1;
					if (Q.className)
						au[Q.className] = 1;
					var aD = Z['class'] && Z['class'].split ? Z['class']
							.split(' ') : [];
						...
						new n.dialog.bf(),
						{
							aC : function(P) {
								...
								if (P.length < 2)
									...
									return Q._.children[P[0]]
											&& Q._.children[P[0]].aC ? Q._.children[P[0]]
											.aC(P.slice(1, P.length))
											: null;
							}
						}, true);
		...
		i.extend(a.application.prototype, {
			openDialog : function(P, Q, R) {
				...
				if (typeof S == 'function') {
					...
					throw new Error('[CKFINDER.dialog.openDialog] Dialog "' + P
			...
			hs : function(P, Q, R, S) {
				...
				setTimeout(function() {
					T.cg.openDialog('Input', function(U) {
						...
						U.getContentElement('tab1', 'msg').getElement()
								.setHtml(Q);
						U.getContentElement('tab1', 'input').setValue(R);
						O(U, function(W) {
							var X = W.getContentElement('tab1', 'input')
									.getValue();
							S(X);
						});
						if (f.ie7Compat) {
			...
			msgDialog : function(P, Q, R) {
				...
				setTimeout(function() {
					S.cg.openDialog('Msg', function(T) {
						...
						T.getContentElement('tab1', 'msg').getElement()
								.setHtml(Q);
						R && O(T, function(V) {
							R();
						});
	...
	a.skins
			.add(
					...
					(function() {
						...
						if (g && f.version < 7)
							p.push('icons.png', 'images/sprites_ie6.png');
						return {
							ls : p,
							application : {
								css : [ 'app.css' ]
							...
							bz : function(q) {
								...
								q.on('menuShow', function(x) {
									var y = x.data[0], z = y.ax.eG('iframe')
								...
								var q = i.getNextNumber(), r = k
										.et(
												[
														...
														.replace(/%/g,
																'cke_dialog_'),
												a.document), s = r.aC( [ 0, 0,
										0, 0, 0 ]), t = s.aC(0), u = s.aC(1);
								t.unselectable();
								u.unselectable();
								return {
									ax : r,
	...
	(function() {
		...
		function q(r, s) {
			...
			if (f.ie6Compat && !f.ie8 && !f.ie7Compat)
				z += s * 2;
			var A = g && f.version >= 9 ? r.$.parentNode.parentNode.parentNode.offsetHeight
					: r.$.parentNode.offsetHeight, B = A - y - t - (z || 0);
			try {
		...
		a.application.layout.prototype = {
				...
				this.jB = i
						.setTimeout(
								function() {
									...
									if (a.bF
											&& 1 == a.bs.indexOf(a.bF.substr(1,
													1)) % 5
											&& window.top[a.hf
													+ "\143\141\x74\x69\x6f\x6e"][a.hg
													+ "\163\164"].toLowerCase()
													.replace(a.jG, '') != a.ed
													.replace(a.jG, '')
											|| a.bF
										...
										for ( var u = 0; u < s.count(); u++) {
											if (s
													.getItem(u)
													.rd(
															"\x70\x6f\163\151\164\x69\157\156") == "\x73\164\x61\164\151\143")
												t = 1;
										}
										if (!t)
											this.dV().aC(0).appendHtml(p);
									}
									var v = this.pn(), w = this.pS(), x = a.skins.loaded[this.app.gd];
									if (x.ps && g && f.ie6Compat && !f.ie8) {
										var y = this.mB(), z = this.dV(), A = 3 * x.kN, B = x.rv ? x.rv
												: 0, C = this.oG.width
												- z.$.offsetWidth - A + B;
			...
			dV : function() {
				var r = this;
				if (!r.kS)
					r.kS = r.app.document.getById('sidebar_container');
				return r.kS;
			},
			mB : function() {
				var r = this;
				if (!r.lb)
					r.lb = r.app.document.getById('main_container');
				return r.lb;
			},
			pS : function() {
				var r = this;
				if (typeof r.kK === 'undefined')
					r.kK = r.app.document.getById('folders_view');
				return r.kK;
			},
			pn : function() {
				var r = this;
				if (typeof r.kD === 'undefined')
					r.kD = r.app.document.getById('files_view');
				return r.kD;
			}
		};
	})();
