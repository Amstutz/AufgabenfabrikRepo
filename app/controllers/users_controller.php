...
class UsersController extends AppController {
	...
	function beforeFilter( ){
		parent::beforeFilter();
		$this->Auth->allow(array('add','initDB'));
	...
	function view($id = null) {
		...
		$edit = false;
		if($id == $this->Auth->user('id')){$edit = true;}
	...
	function add() {
		if (!empty($this->data)) {
			...
			if ($this->User->save($this->data)) {
				$this->Session->setFlash(__('Sie haben sich erfolgreich registriert.', true));
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('Sie konnten nicht registriert werden.', true));
			}
		}
	...
	function initDB() {
		...
		$this->Acl->allow($group, 'controllers/carts/save');
